		...
		<div class="card-body row">
					  ...
					  <div class="card-body">
						<form class="form" method="post" >
						  <div class="form-body"><h5><i class="ft-zap"></i> <b>PILIH SOAL UJIAN</b><hr/></h5>
							<div class="row">
								  ...
								  <option value=''>PILIH MATERI PELAJARAN</option>
								   <?php
									$query = mysqli_query($config, "SELECT a.idmk, a.mkl FROM nio_mkl a
																	INNER JOIN m_soal b ON a.idmk=b.id_mapel 
																WHERE id_mapel NOT IN (SELECT id_mapel FROM m_jawaban WHERE id_murid='$nidn') and semester = '$semester'
																	GROUP BY idmk");
...
<script>
	...
	// }
	      ...
	      $.ajax({
	        ...
	        data: data,
	        success: function() {
	         $('.tampildata').load("apps/jawab_ujian.php?id_mapel="+mapel);
	        }
	      });
